...
**קישור ל-GitHub:** [machine-learning](https://github.com/shirelhaddad/machine-learning/tree/main)
...
עם מניעת זליגת נתונים *10-Fold Cross Validation* אימות בשיטת
הפיצרים מבוססי חישובים תלויים רק בנתוני עבר ורק על סט האימון 
---
